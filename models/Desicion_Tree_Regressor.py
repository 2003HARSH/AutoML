...
class Decision_Tree_Regressor:
    ...
    def set_params(self):
         ...
         try:
             ...
             self.criterian=st.selectbox('criterian',options=['squared_error','friedman_mse','absolute_error','poisson'])
    ...
    def fit(self):
        ...
        clf = DecisionTreeRegressor(criterion=self.criterian,splitter=self.splitter,max_depth=self.max_depth,min_samples_split=self.min_samples_split,min_samples_leaf=self.min_samples_leaf,min_weight_fraction_leaf=self.min_weight_fraction_leaf,max_features=self.max_features,min_impurity_decrease=self.min_impurity_decrease,ccp_alpha=self.ccp_alpha)
